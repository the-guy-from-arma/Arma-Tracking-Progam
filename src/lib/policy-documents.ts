...
export const INITIAL_POLICIES: Array<{
...
}> = [
  {
    ...
    content: {
      plainLanguage: "You must be 18 or older, protect your account, use the campus lawfully, and understand that this online service may change or be unavailable.",
      sections: [
  ...
  },
  {
    ...
    content: {
      ...
      sections: [
        { heading: "Information collected", paragraphs: ["The university collects account and application data; academic goals and progress; enrollments; ledger statistics; submissions and public evidence links; grades and appeals; faculty messages; policy signatures and inquiries; device, session, and technical data; and security and audit records."] },
        ...
        { heading: "Providers and public information", paragraphs: ["Railway, database infrastructure, Google Gemini, and services behind student-provided external links may act as service providers or subprocessors as applicable. Their handling is governed by contracts and terms available to the Operators.", "A credential is public only when its visibility is enabled. Student-provided Workshop, demo, portfolio, and reference links may already be public and are governed by the external service."] },
  ...
  },
  {
    ...
    content: {
      ...
      sources: [{ label: "FTC report on the E-SIGN consumer-consent provision", url: "https://www.ftc.gov/sites/default/files/documents/reports/report-congress-electronic-signatures-global-and-national-commerce-act-consumer-consent-provision/esignreport.pdf" }],
    },
  },
];
