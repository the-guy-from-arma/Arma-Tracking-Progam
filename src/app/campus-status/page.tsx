...
export default async function CampusStatusPage() {
  ...
  return <main className={styles.page} data-season={status.season}>
    <header><Link href="/"><Image src="/enscript-university-lockup.png" alt="Enscript University" width={1983} height={793} priority /></Link><span>INSTITUTIONAL STATUS</span></header>
