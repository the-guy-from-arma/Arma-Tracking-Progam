...
export const INITIAL_POLICIES: Array<{
  ...
  },
  {
    ...
    content: {
      ...
      sections: [
        { heading: "Institutional status", paragraphs: ["Enscript University is an independent, non-accredited online learning institution. It is not authorized to award accredited degrees and is not a college, university, licensing board, or governmental education provider for accreditation purposes."] },
  ...
  },
  {
    ...
    content: {
      ...
      sections: [
        ...
        { heading: "Withdrawal and paper copies", paragraphs: ["You may withdraw electronic consent through the Policy Contact system. Because Enscript University is online-only, withdrawal closes online academic access after required record processing. Paper-copy requests will be handled through the same inquiry system where legally required."] },
      ],
